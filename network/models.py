...
from keras.layers import Activation, Conv2DTranspose, BatchNormalization
...
def uNet_256(input_shape=(256, 256, 3), num_classes=1):
    ...
    down0 = Conv2D(8, (3, 3), padding='same')(down0)
    down0 = BatchNormalization()(down0)
    down0 = Activation('relu')(down0)
    ...
    up4 = Conv2DTranspose(128, (2, 2), strides=(2, 2), padding='same')(center)
    ...
    up3 = Conv2DTranspose(64, (2, 2), strides=(2, 2), padding='same')(up4)
    ...
    up2 = Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='same')(up3)
    ...
    up1 = Conv2DTranspose(16, (2, 2), strides=(2, 2), padding='same')(up2)
    ...
    up0 = Conv2DTranspose(8, (2, 2), strides=(2, 2), padding='same')(up1)
